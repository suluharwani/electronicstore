...
<head>
  ...
  <link href="<?=base_url('assets/startbootstrap')?>/css/shop-homepage.css" rel="stylesheet">
...
<body>
  ...
  <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color : #0fd15c">
    <div class="container">
      <a class="navbar-brand" href="#">Suluh</a>
